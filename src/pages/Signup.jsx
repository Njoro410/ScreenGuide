              ...
              >
                <div className="relative">
                  <input
                    ...
                    className="block p-3 my-2 rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-300 bg-gray-700 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-green-400 peer"
                    placeholder=" "
                  />
                  <label
                    for="email"
                ...
                <div className="relative">
                  <input
                    ...
                    className="block my-2 p-3 rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-300 bg-gray-700 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-green-400 peer"
                    placeholder=" "
                  />
                  <label
                    for="password"
                ...
                <button className="bg-green-400 hover:bg-green-600 py-3 my-1 rounded font-bold text-white">
                  Sign Up
                </button>
                <button
